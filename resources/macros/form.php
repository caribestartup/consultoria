...
Form::macro('myInput', function($type="text", $name, $label="", $placeholder="", $options=[], $default = null)
{
    $label = ($label =='') ? '' : html_entity_decode(Form::label($name, $label));
    return "
        <div class='form-group'>
            ". $label . 
              Form::input($type, $name, $default, array_merge(["placeholder" => $placeholder, "class" => "form-control"], $options)). "
        </div>
    ";
});
