            ...
            <div class="col-md-6 bg-white">
                <div class="row">
                    ...
                    <div class="col-md-8 pl-0  bg-white pt-2">
                        <input type="text" class="border-0 graywithout" name="value" value="{{$department->value}}" placeholder="Introduzca el nombre del departamento" style="width: 100%" disabled>
                    </div>
