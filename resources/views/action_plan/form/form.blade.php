            ...
            <div class="pL-20 pR-20 ">
                ...
                <div class="form-group guided-type">
                    <div class="custom-checkbox custom-control custom-control-inline">
                        <input type="checkbox" class="custom-control-input" name="configuration[has_coach]" id="has-coach"
                    ...
                    <div id="coach" class="mT-5" @if(!isset($actionPConfig) or (isset($actionPConfig) and !$actionPConfig->has_coach))
                    style="display: none"
                            @endif >
                        <div class="form-group">
