...
@section('content-chatbot')
    ...
    <div class="row">
        <div class="col-md-1">
             <span class="img-menu ">
            <img class="mt-3" src="{{ asset("images/vara.png") }}" width="33px" height="315px">
        </span>
        </div>
        <div class="col-md-11">
            <div class="row">
                <div class="col-md-4 d-flex flex-column">
                    ...
                    <input class="mb-3 light-brown" type="text" name="name" id="name" style="border-radius: 35px">
                    <label class="mb-3">Descripcion</label>
                    <textarea class="mb-3 light-brown" name="description" id="description" style="border-radius: 35px"></textarea>
                ...
                <div class="col-md-4 d-flex flex-column">
                    ...
                    <textarea class="mb-5 light-brown" style="border-radius: 35px" name="default_response" id="default_response"></textarea>
    ...
    <div class="row">
        ...
        <div class="col-md-4 d-flex flex-row">/
            ...
            <span class="img-menu">
                ...
                <button  class="bg-transparent" style="border:0">
                    <img src="{{ asset("images/assets/micro_contents.png") }}" height="35px" width="35px" />
