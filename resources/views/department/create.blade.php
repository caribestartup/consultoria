...
@section('content')
    ...
    @include('components.index_top', ['indexes' => [
            trans_choice('common.department', 2),	__('common.new')
            ]])
    {!! Form::open([
        ...
        <div class="col-md-6 bg-white">
            <div class="row">
                ...
                <div class="col-md-8 pl-0  bg-white pt-2">
                    <input type="text" class="border-0 graywithout" name="value" placeholder="Introduzca el nombre del departmento" style="width: 100%">
                </div>
