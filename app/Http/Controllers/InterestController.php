...
class InterestController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('interest.index', compact('interests'),compact('minI'));
...
//
        ...
        $interests->topics()->sync($request->topic_id);
        //$interests->topics()->sync($request->get('topic[]'));
        /*DB::table('interest_topic')->insert([

            'interest_id' => $interests->id,
            'topic_id' =>  $interests->topics()->attach($request->get('id'))

        ]);*/
       /* $interests->topics()->attach($request->get('topic[]'));*/
